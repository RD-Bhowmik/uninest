            ...
            <div> 
                <form>
                    ...
                    <div className="flex gap-2">
                        <input value={photoLink} onChange={ev => setPhotoLink(ev.target.value)} type="text" placeholder="Link of your photos"/>
                    ...
                    <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                        ...
                        <button className="text-primary border-primary flex items-center gap-1 border bg-transparent rounded-2xl p-4 text-xl  justify-center text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <div className="grid gap-2 sm:grid-cols-3">
                        ...
                        <h3 className="mt-2 -mb-1" >Check In time:</h3>
                            <input type="text" value={checkIn} onChange={ev => setCheckIn(ev => ev.target.value)} placeholder="9:00"/>
                        </div>
                        <div>
                        <h3 className="mt-2 -mb-1" >Check Out time:</h3>
                            <input type="text" value={checkOut} onChange={ev => setCheckOut(ev => ev.target.value)} placeholder="22:00"/>
                        </div>
                        <div>
                        <h3 className="mt-2 -mb-1" >Max Num of People:</h3>
                            <input type="number" value={maxGuest} onChange={ev => setMaxGuest(ev => ev.target.value)}/>
                        </div>
                        <div>
