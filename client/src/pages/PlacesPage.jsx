...
export default function PlacesPage() {
    ...
    const [places, setPlaces] = useState([]); // Renamed to 'places' for consistency
    useEffect(() => {
        ...
        <div>
            ...
            <div className="mt-4">
                {places.length > 0 && places.map(place => (
                    <Link to={'/account/place/view/' + place._id} key={place._id} className="flex cursor-pointer gap-5 bg-gray-200 p-4 rounded-2xl">
