            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    <div className="flex h-32 relative" key={link}>
                        <img className="rounded-2xl w-full object-cover" src={'http://localhost:4000/' + link} alt="Uploaded Photo" />
                ...
                <label className="text-primary cursor-pointer border-primary flex items-center gap-1 border bg-transparent rounded-2xl p-4 text-xl justify-center text-gray-600">
